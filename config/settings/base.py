...
MIDDLEWARE = [
    ...
    "apps.core.middleware.ClinicOnboardingMiddleware",
]
...
DATABASES = {
    "default": dj_database_url.config(
        env="DATABASE_URL",
        default="postgres://postgres@localhost:5432/dokterklik",
        conn_max_age=600,
    )
}
...
# SATUSEHAT
SATUSEHAT_BASE_URL = config(
    "SATUSEHAT_BASE_URL", default="https://api-satusehat-stg.dto.kemkes.go.id"
)
